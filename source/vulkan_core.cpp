...
namespace TWE
{
    ...
    vulkan_core::vulkan_core( const window& wnd, const std::string& app_name, uint32_t app_version )
    {
        ...
        instance_ = check_vk_return_type_result(
        ...
        {
            debug_report_ = check_vk_return_type_result(
    ...
    const vk_return_type<VkInstance> vulkan_core::create_instance( const std::vector<const char*>& extensions,
    ...
    const vk_return_type<VkDebugReportCallbackEXT> vulkan_core::create_debug_report( const VkInstance& instance ) const noexcept
    {
    ...
    const vk_return_type<VkPhysicalDevice> vulkan_core::pick_physical_device( const VkSurfaceKHR& surface,
            const std::vector<const char*>& device_extensions ) const noexcept
    {
        ...
        return { VK_SUCCESS, nullptr };
    }

    const vk_return_type<VkDevice> vulkan_core::create_device( ) const noexcept
    {
