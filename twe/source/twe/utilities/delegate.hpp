...
#ifndef TWE_DELEGATES_H
#define TWE_DELEGATES_H
...
//  assert(stub_ptr);
    ...
    namespace std
    {
        ...
        struct hash<::twe::delegate<R( A... )> >
        {
            size_t operator()( ::twe::delegate<R( A... )> const& d ) const noexcept
            {
                auto const seed( hash<void *>( )(d.object_ptr_));
                
                return hash<typename ::twe::delegate<R( A... )>::stub_ptr_type>( )(
