...
namespace twe
{
    namespace vulkan
    {
            ...
            height_( create_info.height_ )
        {
            ...
            std::uint32_t image_count = support_details.capabilities_.minImageCount + 1;
            if( support_details.capabilities_.maxImageCount > 0 &&
                image_count > support_details.capabilities_.maxImageCount )
            {
                image_count = support_details.capabilities_.maxImageCount;
            }
            ...
            swapchain_ = create_handle<vk::UniqueSwapchainKHR>( create_info.device_, create_info.surface_, present_mode, support_details.capabilities_, image_count );
