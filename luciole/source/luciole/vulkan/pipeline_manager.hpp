...
#ifndef LUCIOLE_VULKAN_PIPELINE_MANAGER_HPP
#define LUCIOLE_VULKAN_PIPELINE_MANAGER_HPP
...
namespace lcl::vulkan
{
    ...
    {
    public:
        LUCIOLE_API pipeline_manager( ) = default;
        LUCIOLE_API pipeline_manager( const pipeline_manager& rhs ) = delete;
        LUCIOLE_API pipeline_manager( pipeline_manager&& rhs ) noexcept;
        LUCIOLE_API ~pipeline_manager( ) = default;

        LUCIOLE_API pipeline_manager& operator=( const pipeline_manager& rhs ) = delete;
        LUCIOLE_API pipeline_manager& operator=( pipeline_manager&& rhs ) noexcept;
...
#endif //LUCIOLE_VULKAN_PIPELINE_MANAGER_HPP
