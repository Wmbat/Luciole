...
#ifndef LUCIOLE_VULKAN_CONTEXT_HPP
#define LUCIOLE_VULKAN_CONTEXT_HPP
...
namespace lcl::vulkan
{
    ...
    private:
        ...
        struct queue_family_info
        {
            ...
            /*!
             * @brief check if the queue family has rendering support
             * @return True if the queue is capable of rendering and False
             * if it is not.
             */
            bool has_rendering_support( ) const noexcept;
            /*!
             * @brief check if the queue family has support for all queues
             * @return True if the queue is capable of everything and False
             * if it is not.
             */
            bool is_general_purpose( ) const noexcept;
            /*!
             * @brief check if the queue family is dedicated for transfer
             * @return True if the queue is dedicated to transfer and False
             * if it is not.
             */
            bool is_dedicated_transfer( ) const noexcept;
            /*!
             * @brief check if the queue family is dedicated for graphics
             * @return True if the queue is dedicated to graphics and False
             * if it is not.
             */
    ...
    private:
        ...
        /* Functions for the creation of Vulkan Objects. */
        ...
        /*!
         * @brief template function to check for extension support of certain devices
         * such as VkInstance and VkDevice.
         * @param properties. An extension_properties_trait to determine what type
         * of extension it should handle.
         * @return True if the Vulkan object has support for the extensions ore note
         */
        template<class vk_object_type>
...
#endif //LUCIOLE_VULKAN_CONTEXT_HPP
