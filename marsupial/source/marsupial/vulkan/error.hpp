...
#ifndef MARSUPIAL_VULKAN_ERROR_H
#define MARSUPIAL_VULKAN_ERROR_H
...
namespace marsupial::vulkan
{
    ...
    public:
         ...
         */
        MARSUPIAL_API error( const vk::Result& result, const std::string& message );
    };
    
}

#endif //MARSUPIAL_VULKAN_ERROR_HPP
