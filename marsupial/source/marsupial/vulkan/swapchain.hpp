...
#ifndef MARSUPIAL_VULKAN_SWAPCHAIN_HPP
#define MARSUPIAL_VULKAN_SWAPCHAIN_HPP
...
namespace marsupial::vulkan
{
    ...
    public:
        MARSUPIAL_API swapchain( ) = default;
        
        MARSUPIAL_API swapchain( const create_info_type& create_info );
        
        MARSUPIAL_API swapchain( const swapchain& rhs ) = delete;
        
        MARSUPIAL_API swapchain( swapchain&& rhs );
        
        MARSUPIAL_API ~swapchain( ) = default;
        
        MARSUPIAL_API swapchain& operator=( const swapchain& rhs ) = delete;
        
        MARSUPIAL_API swapchain& operator=( swapchain&& rhs );
        
        MARSUPIAL_API void recreate( const create_info_type& create_info );
...
#endif //MARSUPIAL_VULKAN_SWAPCHAIN_HPP
