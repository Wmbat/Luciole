...
#ifndef MARSUPIAL_VULKAN_VERTEX_BUFFER_HPP
#define MARSUPIAL_VULKAN_VERTEX_BUFFER_HPP
...
namespace marsupial::vulkan
{
    ...
    public:
        MARSUPIAL_API vertex_buffer( ) = default;
        MARSUPIAL_API vertex_buffer( const create_info_type& create_info );
        MARSUPIAL_API vertex_buffer( const vertex_buffer& rhs ) = delete;
        MARSUPIAL_API vertex_buffer( vertex_buffer&& rhs ) noexcept;
        MARSUPIAL_API ~vertex_buffer( );
        
        MARSUPIAL_API vertex_buffer& operator=( const vertex_buffer& rhs ) = delete;
        MARSUPIAL_API vertex_buffer& operator=( vertex_buffer&& rhs ) noexcept;
        
        MARSUPIAL_API const vk::Buffer& get( ) const noexcept;
...
#endif //MARSUPIAL_VULKAN_VERTEX_BUFFER_HPP
