...
#ifndef MARSUPIAL_MARSUPIAL_CORE_HPP
#define MARSUPIAL_MARSUPIAL_CORE_HPP

#include <cstdint>

#if defined( MARSUPIAL_PLATFORM_WINDOWS )
#if defined( MARSUPIAL_BUILD_DLL )
#define MARSUPIAL_API __declspec( dllexport )
#else
#define MARSUPIAL_API __declspec( dllimport )
#endif
#else
#define MARSUPIAL_API
#endif
...
#endif //MARSUPIAL_MARSUPIAL_CORE_HPP