...
#ifndef MARSUPIAL_UTILITIES_DELEGATES_H
#define MARSUPIAL_UTILITIES_DELEGATES_H
...
//  assert(stub_ptr);
    ...
    namespace std
    {
        ...
        struct hash<::marsupial::delegate<R( A... )> >
        {
            size_t operator()( ::marsupial::delegate<R( A... )> const& d ) const noexcept
            {
                auto const seed( hash<void *>( )(d.object_ptr_));
                
                return hash<typename ::marsupial::delegate<R( A... )>::stub_ptr_type>( )(
...
#endif //MARSUPIAL_UTILITIES_DELEGATES_H
