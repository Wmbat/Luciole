...
#ifndef MARSUPIAL_UTILITIES_BASIC_ERROR_HPP
#define MARSUPIAL_UTILITIES_BASIC_ERROR_HPP
...
namespace marsupial
{
    ...
    public:
         ...
         */
        MARSUPIAL_API basic_error( const code& code, const std::string& message );
    };
}

#endif //MARSUPIAL_UTILITIES_BASIC_ERROR_HPP
