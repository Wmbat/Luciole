...
#ifndef MARSUPIAL_WINDOW_BASE_WINDOW_HPP
#define MARSUPIAL_WINDOW_BASE_WINDOW_HPP
...
namespace marsupial
{
    ...
    public:
        ...
        MARSUPIAL_API virtual void poll_events( ) = 0;
    
        MARSUPIAL_API bool is_open( ) const noexcept;
    
        MARSUPIAL_API virtual vk::UniqueSurfaceKHR create_surface( const vk::Instance& instance ) const noexcept = 0;
    
        MARSUPIAL_API uint32_t get_width( ) const noexcept;
        MARSUPIAL_API uint32_t get_height( ) const noexcept;
...
#endif //MARSUPIAL_WINDOW_BASE_WINDOW_HPP