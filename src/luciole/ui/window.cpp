   ...
   is_fullscreen_( false )
{
   ...
   window_logger_ = std::shared_ptr<spdlog::logger>( 
   ...
   window_logger_->info(
      "Window ID generated: {0}.", std::to_string( xcb_window_ )
   );
   ...
   vk::instance_t instance ) const
{
   ...
   vk::error const err( vk::result_t(
      vkCreateXcbSurfaceKHR( instance.value_, &create_info, nullptr, &surface )
   ) );
