...
namespace vk
{
      ...
      memory_allocator( create_info.value( ).memory_allocator ), allocation( VK_NULL_HANDLE ), buffer( VK_NULL_HANDLE )
   {
      ...
      vmaCreateBuffer( memory_allocator, &staging_create_info, &staging_allocation_info, &staging_buffer, &staging_memory, nullptr );
      ...
      vmaCreateBuffer( memory_allocator, &vertex_buffer_create_info, &allocation_info, &buffer, &allocation, nullptr );
   ...
   vertex_buffer::vertex_buffer( vertex_buffer&& rhs ) { *this = std::move( rhs ); }
